    ...
    jQuery('.spinner').animate({'opacity':0},1000,'easeOutCubic',function (){jQuery(this).css('display','none')});	
		...
		$( "#search" ).autocomplete({ 
		 ...
		 $("#search").blur(function(){
			 var str="painter.jsp?#"+$("#search").val();
			 $("#tiao").attr("href",str);
		 });
    ...
    <div class="row">
        ...
        <div class="navbar navbar_">
            ...
            <div class="nav-collapse nav-collapse_  collapse">
                ...
                <li class="active"><a href="showpainter">画师</a></li>
    ...
    <div class="container">
    	 <div class="row">
         	...
         	<br>
         		...
         		<a  class="btn btn-1" id="tiao">Search</a> 
        		</div>
             	<div class="ui-widget"> <input type="text" name="search" id="search">
             	</div>
        ...
        <article class="span8 offset2">
         ...
         <div class="inner-1">   
          ...
          <s:iterator var="pai" value="#session.painterList" status="status">
          
          
            <li> 
            <a name="<s:property value="#pai.name"/>"></a> 
            <br/>
            <h3><s:property value="#pai.name"/></h3>     
            <time  class="date-1"><s:property value="#pai.hiredate"/></time>
            <div class="name-author">代表作  by <a href="javascript:;">wacom</a></div>
            <div class="clear"></div>            
              <img alt="这是图片" src="<s:property value="#pai.img"/>">                               
              <p><s:property value="#pai.intro"/></p>
              <a href="javascript:;" class="btn btn-1">Read More</a>          
            </li> 
            </s:iterator> 
