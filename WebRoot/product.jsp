    ...
    <div class="row">
        ...
        <div class="navbar navbar_">
            ...
            <div class="nav-collapse nav-collapse_  collapse">
                ...
                <li class="active"><a href="product.jsp">作品</a></li>
    ...
    <div class="container">
        ...
        <div class="clear"></div>
         <ul class="portfolio clearfix">           
          <li class="box"><a href="img/page3-imglg1.jpg" class="magnifier" ><img alt="" src="img/page3-img1.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg2.jpg" class="magnifier" ><img alt="" src="img/page3-img2.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg3.jpg" class="magnifier" ><img alt="" src="img/page3-img3.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg4.jpg" class="magnifier" ><img alt="" src="img/page3-img4.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg5.jpg" class="magnifier" ><img alt="" src="img/page3-img5.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg6.jpg" class="magnifier" ><img alt="" src="img/page3-img6.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg7.jpg" class="magnifier" ><img alt="" src="img/page3-img7.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg8.jpg" class="magnifier" ><img alt="" src="img/page3-img8.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg9.jpg" class="magnifier" ><img alt="" src="img/page3-img9.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg10.jpg" class="magnifier" ><img alt="" src="img/page3-img10.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg11.jpg" class="magnifier" ><img alt="" src="img/page3-img11.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg12.jpg" class="magnifier" ><img alt="" src="img/page3-img12.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg13.jpg" class="magnifier" ><img alt="" src="img/page3-img13.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg14.jpg" class="magnifier" ><img alt="" src="img/page3-img14.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg15.jpg" class="magnifier" ><img alt="" src="img/page3-img15.jpg"></a></li> 
           <li class="box"><a href="img/page3-imglg16.jpg" class="magnifier" ><img alt="" src="img/page3-img16.jpg"></a></li>                       
            </ul> 
      </div>
        </div>
  </div>
