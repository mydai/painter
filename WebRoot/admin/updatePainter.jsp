...
<body>
<s:debug></s:debug>
	<form action="painter_updatePainter" enctype="multipart/form-data"
		...
		<div class="" id="updatePainters">
			<div class="container-fluid" id="left">
				...
				<lable id="hidd"> <input type="hidden" id="painterid"
					value="<s:property value='painter.painterid'/>"
				...
				<div class="row">
					<div class="form-group has-feedback col-xs-7 col-xs-offset-1">
						<span class="label label-primary">用户名</span> <label
							...
							value="<s:property value='painter.name'/>" name="painter.name"
							disabled>
					</div>
				</div>
				<div class="row">
					<div class="form-group has-feedback col-xs-7 col-xs-offset-1">
						<span class="label label-primary">密码</span> <label
							...
							name="painter.pwd" value="<s:property value='painter.pwd'/>">
					</div>
				</div>
				<div class="row">
					<div class="form-group has-feedback col-xs-7 col-xs-offset-1">
						<span class="label label-primary">余额</span> <label
							...
							name="painter.money" value="<s:property value="painter.money"/>">
					</div>
				</div>
				<div class="row">
					<div class="form-group has-feedback col-xs-7 col-xs-offset-1">
						<span class="label label-primary">积分</span> <label
							...
							name="painter.score" value="<s:property value="painter.score"/>">
					</div>
				</div>
				<div class="row">
