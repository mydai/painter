...
<body>
	<div class="container row" id="login">
		<h1 class="col-xs-4 col-md-offset-6">后台登陆</h1>
		<br> <br> <br> <br>
		...
		<div class="input-group col-xs-5 col-md-offset-5">
			...
			<div style="margin: 10px 10px;float:left;" id="yanzhengma">
				<img src="image.jsp" title="点击刷新"
					onclick="src='image.jsp?'+Math.random()"><b>点击图片刷新</b>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		function login() {
			...
			$.getJSON("admin_login", jsonStr, function(result) {

				if (result.tips == "登录成功" && result.flag == true) {
					layer.msg(result.tips);
					setInterval("location.href = 'admin/main.jsp'", 500);
				} else {
					layer.msg(result.tips);
				}
			});
